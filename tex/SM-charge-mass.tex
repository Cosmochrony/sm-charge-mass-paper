...
\title{Charge, Mass, and Inertia as Saturated Responses in a Pre-Geometric Relational Description}
...
\begin{document}
  ...
  \abstract{
    ...
    A finite projective capacity necessarily induces Born--Infeld--type nonlinearities,
    ...
    corresponding to the phase fiber associated with non-injective projection
    of the underlying relational configuration space.

    The proposed framework does not modify Standard Model dynamics
    within experimentally accessible regimes and does not
  ...
  If at least two relational degrees of freedom remain unresolved,
  the saturation-preserving manifold is necessarily a compact connected
  one-dimensional space, uniquely $S^1$.

  This residual $S^1$ structure can be interpreted geometrically as the
  phase fiber associated with a non-injective projection of the underlying
  relational configuration space.
  When multiple microscopic configurations correspond to the same effective
  state, the effective description admits a compact fiber representing the
  remaining undetermined phase.
  The resulting phase degree of freedom naturally carries a $U(1)$ symmetry,
  and oriented saturation of the relaxation flux defines a conserved
  invariant associated with this fiber.
  ...
  \subsection{Conceptual implications}
    ...
    Mass appears as a spectral gap induced by isotropic saturation, while electric charge emerges as the generator of a
    local phase degeneracy associated with
    oriented saturation.
    Geometrically, this degeneracy corresponds to the phase fiber induced by
    non-injective projection of the underlying relational configuration space,
    which naturally carries a $U(1)$ symmetry.
  ...
  \subsection{Relation to existing foundational approaches}
    ...
    Within this perspective, gauge structures need not be introduced as independent
    symmetry postulates.
    Instead they can arise from degeneracies of the effective description induced by
    non-injective projection, with phase symmetries appearing as residual fiber
    degrees of freedom of the projection.
  ...
  \subsection{Limitations of the present work}
    ...
    all effective closures, nor to predict numerical values for particle masses, charges, or coupling constants.
    The present analysis identifies structural invariants associated with these
    quantities but leaves their numerical values to be fixed by the detailed
    microscopic realization of the relational dynamics.
  ...
  \subsection{Possible extensions and outlook}
    ...
    If mass and charge are effective descriptors tied to the finite descriptive
    capacity of a non-injective effective projection,
